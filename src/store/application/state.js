...
export default {
  ...
  table: {
    ...
    tableData: [
      { name: 'Fulano', doed: 5, doing: 4, todo: 3 },
      { name: 'Ciclano', doed: 4, doing: 3, todo: 3 },
      { name: 'Beltrano', doed: 3, doing: 1, todo: 3 },
      { name: 'Xico', doed: 2, doing: 1, todo: 3 },
      { name: 'Jorge', doed: 1, doing: 3, todo: 3 },
      { name: 'Diego', doed: 5, doing: 4, todo: 3 },
      { name: 'Isaias', doed: 4, doing: 3, todo: 3 },
      { name: 'Tobias', doed: 3, doing: 1, todo: 3 },
      { name: 'Eber', doed: 2, doing: 1, todo: 3 },
      { name: 'Marcell', doed: 1, doing: 3, todo: 3 }
    ]
  }
}
